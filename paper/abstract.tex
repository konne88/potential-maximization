...
strategies, which we 
term ``potential-maximizing'' strategies, as they prioritize an
agent's long-term capacity to influence its environment over greedily maximizing
a reward. We prove robustness using the concept of an Evolutionarily Stable Strategy (ESS),
in a multi-agent universe model that is generic in how agents interact with one
